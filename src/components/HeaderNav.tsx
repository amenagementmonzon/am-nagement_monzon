    ...
    >
      ...
      {activePresetId === "hardscape-landscape" && (
        ...
        >
          ...
          >
            <img
              src={activeLogoUrl || "https://c.animaapp.com/mmr3v89y52bO3P/img/uploaded-asset-1773625307363-0.png"}
        ...
        <DesktopNav
          ...
          servicesLabel={t.nav.servicesDropdown}
        />
        ...
        <div className="hidden md:flex items-center gap-2">
          {isAnonymous ? (
            <>
              ...
              >
                <UserCircle size={14} weight="thin" /> {t.nav.signIn}
              </button>
              <Link
                to="/register"
          ...
          <LanguageSelector light={isLightHeader} />
