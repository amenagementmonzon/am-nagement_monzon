...
const FALLBACK_POSTS = [
  { image: "https://c.animaapp.com/mmr3v89y52bO3P/img/ai_5.png", platform: "Instagram", handle: "@amenagement_monzon", likes: "1.2K", views: "14K" },
  { image: "https://c.animaapp.com/mmr3v89y52bO3P/img/ai_4.png", platform: "YouTube",   handle: "@AmenagementMonzon",  likes: "3.4K", views: "89K" },
  { image: "https://c.animaapp.com/mmr3v89y52bO3P/img/ai_3.png", platform: "Instagram", handle: "@amenagement_monzon", likes: "2.1K", views: "22K" },
  { image: "https://c.animaapp.com/mmr3v89y52bO3P/img/ai_2.png", platform: "TikTok",    handle: "@monzon.builds",      likes: "890",  views: "45K" },
  { image: "https://c.animaapp.com/mmr3v89y52bO3P/img/ai_5.png", platform: "YouTube",   handle: "@AmenagementMonzon",  likes: "5.6K", views: "112K" },
];
      ...
      <div className="relative max-w-screen-xl mx-auto px-6 md:px-10">
        ...
        <div ref={headerRef} className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-14" data-delay="0">
          <div>
            ...
            <h2 className="font-headline font-bold text-fluid-2xl text-warm-white leading-[1.1]">{t.community.title}</h2>
            <p className="font-sans text-sm text-gray-400 mt-4 max-w-md leading-relaxed">{t.community.subtitle}</p>
          </div>
        ...
        <div ref={statsRef} className="grid grid-cols-3 gap-4 mb-12" data-delay="100">
          {[[t.community.stat1, t.community.stat1Label],[t.community.stat2, t.community.stat2Label],[t.community.stat3, t.community.stat3Label]].map(([value, label], i) => (
