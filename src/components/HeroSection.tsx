...
export default function HeroSection() {
  ...
  const eyebrowText =
    activePresetId === "hardscape-landscape"     ? (t.lang === "fr" ? "Hardscape · Paysagement · Aménagement" : t.lang === "es" ? "Hardscape · Paisajismo · Diseño" : "Hardscape · Landscaping · Design") :
    activePresetId === "construction-renovation" ? (t.lang === "fr" ? "Construction · Rénovation · Intérieurs" : t.lang === "es" ? "Construcción · Renovación · Interiores" : "Construction · Renovation · Interiors") :
    activePresetId === "maintenance-service"     ? (t.lang === "fr" ? "Entretien · Service · Abonnements" : t.lang === "es" ? "Mantenimiento · Servicio · Suscripciones" : "Maintenance · Service · Subscriptions") :
    t.hero.eyebrow;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <video
          ref={videoRef}
          src="https://c.animaapp.com/mmr3v89y52bO3P/img/ai_1.mp4"
          poster="https://c.animaapp.com/mmr3v89y52bO3P/img/ai_1-poster.png"
      ...
      >
        ...
        <h1 className="hero-anim font-headline text-balance max-w-[820px] mb-8" style={{ fontSize: "clamp(3.5rem, 8.5vw, 9rem)", lineHeight: 1.02, letterSpacing: "-0.03em", fontWeight: 300 }}>
          <span className="text-gradient-gold italic">{t.hero.headline2}</span>
        </h1>
      ...
      <button
        ...
        aria-label={videoPaused ? t.hero.play : t.hero.pause}
