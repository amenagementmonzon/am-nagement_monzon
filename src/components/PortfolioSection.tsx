...
const FALLBACK_ITEMS = [
  { src: "https://c.animaapp.com/mmr3v89y52bO3P/img/ai_3.png", alt: "construction team working on site",      title: "Urban Construction",    category: "Construction", year: "2024", size: "tall"   },
  { src: "https://c.animaapp.com/mmr3v89y52bO3P/img/ai_4.png", alt: "modern renovated home exterior",          title: "Modern Home Renovation", category: "Renovation",   year: "2024", size: "wide"   },
  { src: "https://c.animaapp.com/mmr3v89y52bO3P/img/ai_5.png", alt: "landscaping crew community interaction",  title: "Community Landscaping",  category: "Landscaping",  year: "2023", size: "normal" },
  { src: "https://c.animaapp.com/mmr3v89y52bO3P/img/ai_2.png", alt: "abstract metallic dark gradient render",  title: "Luxury Pavé Driveway",   category: "Landscaping",  year: "2024", size: "normal" },
  { src: "https://c.animaapp.com/mmr3v89y52bO3P/img/ai_3.png", alt: "construction team working on site",      title: "Commercial Build",       category: "Construction", year: "2023", size: "normal" },
  { src: "https://c.animaapp.com/mmr3v89y52bO3P/img/ai_5.png", alt: "landscaping crew community interaction", title: "Terrace Garden",         category: "Landscaping",  year: "2024", size: "wide"   },
];

export default function PortfolioSection() {
  const { t } = useLanguage();
  const FILTERS = [t.portfolio.filterAll, t.portfolio.filterConstruction, t.portfolio.filterRenovation, t.portfolio.filterLandscaping, t.portfolio.filterMaintenance];
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-12">
          <div>
            ...
            <h2 className="font-headline font-bold text-fluid-2xl text-charcoal leading-[1.1]">{t.portfolio.title}</h2>
          </div>
          <Link to="/portfolio"
        ...
        <div className="mt-14 flex items-center justify-center">
          <div className="flex items-center gap-6 px-8 py-5 glass-light rounded-2xl border border-gray-200">
            <p className="font-sans text-sm text-gray-500" dangerouslySetInnerHTML={{ __html: t.portfolio.moreNote }} />
            <Link to="/portfolio"
              ...
              {t.portfolio.fullGallery} <ArrowUpRight size={12} weight="bold" />
            </Link>
          </div>
        </div>
      </div>
