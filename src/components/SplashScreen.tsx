...
export default function SplashScreen() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo formation — clicking the wordmark navigates home */}
        <div onClick={isAssembled ? handleLogoClick : undefined} style={{ cursor: isAssembled ? "pointer" : "default" }}>
