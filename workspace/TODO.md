...
<todo id="i18n-db-persist">
Persist translation overrides to DB
I18nManagerPanel currently saves overrides to localStorage per device. Create a TranslationOverride DB entity to sync custom translations across admin sessions and devices.
</todo>
...
<todo id="ai-chat-llm">
Connect Groq AI to chatbot
Integrations panel is configured for Groq. Wire AIChatWidget and AdminAIChat to read VITE_GROQ_CHAT_MODEL / GROQ_API_KEY and call the Groq completions endpoint.
</todo>
